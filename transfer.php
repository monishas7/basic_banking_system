...
$sid=$_GET['id'];
$select = "SELECT * FROM  customers where id=$sid";
...
$sender = $row1['name'];
$receivr = $row2['name'];
$insert = "INSERT INTO history(`sender`, `receiver`, `amount`) VALUES ('$sender','$receivr','$amount')";
